...
const validar = () =>{
    ...
    if(nombreV !== "" && apellidoV !== "" && nombreV.length < 50 && apellidoV.length < 50){
        ...
        validar1.textContent = "El nombre y apellido son correctos.";
    } else{
    ...
    if(edadV > 18){
        ...
        validar2.textContent = "La edad es correcta.";
    }else{
        validar2.style.color = "red";
        validar2.textContent = "La edad no debe ser negativa y tampoco ser menor de edad.";        
    }
    const alturaV = altura.value;
    if(alturaV > 0 && alturaV < 230){
        validar3.style.color = "green";
        validar3.textContent = "La altura es correcta.";
    }else{
    ...
    if(correoV.length > 0 && correoV.includes("@")){
        ...
        validar4.textContent = "El correo electrónico es correcto.";
    }else{
